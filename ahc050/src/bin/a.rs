...
// fn compute_score_details(input: &Input, out: &[(usize, usize)]) -> (i64, String, FieldState, Vec<f64>) {
//     let mut s = input.s.clone();
//     let mut crt = vec![vec![0.0; N]; N];
//     for i in 0..N {
//         for j in 0..N {
//             if input.s[i][j] == '.' {
//                 crt[i][j] = 1.0 / (N * N - input.m) as f64;
//             }
//         }
//     }
//     let mut ret = 0.0;
...
//                     let mut i2 = i;
//                     let mut j2 = j;
//                     while i2 + di < N && j2 + dj < N && s[i2 + di][j2 + dj] == '.' {
//                         i2 += di;
//                         j2 += dj;
//                     }
...
//     let ub = (N * N - input.m - 1) as f64;
//     let score = (ret / ub * 1e6).round() as i64;
//     let err = if out.len() < N * N - input.m {
//         "Not finished".to_owned()
//     } else {
//         String::new()
//     };
//     (score, err, FieldState { s, prob: crt }, lives)
// }
